...
class WxPayDataBase
{
	...
	public function genera_mch_billno(){
		return WxPayConfig::MCHID . date("YmdHis") . rand(1000,9999);
	}
...
class WxPayRedPack extends WxPayDataBase
{
	...
	/**
	 * 设置接收红包用户的openid，此参数必传，接受收红包的用户,用户在wxappid下的openid。
	 * @param string $value
	 **/
	public function SetReceiveOpenid($value)
	{
	 ...
	 * @return true 或 false
	 **/
	public function IsReceiveOpenidSet()
	{
	 ...
	 * @param string $value
	 **/
	public function SetShare_content($value)
	{
	 ...
	 * @return 值
	 **/
	public function GetShare_content()
	{
	 ...
	 * @return true 或 false
	 **/
	public function IsShare_contentSet()
	{
		return array_key_exists('share_content', $this->values);
	}
	 ...
	 * @param string $value
	 **/
	public function SetShare_url($value)
	{
	 ...
	 * @return true 或 false
	 **/
	public function IsShare_urlSet()
	{
		return array_key_exists('share_url', $this->values);
	}
	 ...
	 * @param string $value
	 **/
	public function SetShare_imgurl($value)
	{
	 ...
	 * @return 值
	 **/
	public function GetShare_imgurl()
	{
	 ...
	 * @return true 或 false
	 **/
	public function IsShare_imgurlSet()
	{
		return array_key_exists('share_imgurl', $this->values);
	}
