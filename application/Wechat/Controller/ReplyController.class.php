...
class ReplyController extends AdminbaseController {
    ...
    public function index() {
        ...
        $list = D('Reply')->get_reply_list($filter, $offset);
    ...
    function parse_query_condition(){
        ...
        $filter['sort_by']      = empty($_REQUEST['sort_by']) ? 'T.reply_id' : trim($_REQUEST['sort_by']);
    ...
    public function insert(){
        ...
        */
        ...
        {
            // model('Admin')->admin_log($goods_id, 'add', 'reply');
    ...
    public function update(){
        ...
        {
            //model('Admin')->admin_log($id, 'edit', 'reply');
    ...
    function query(){
        ...
        $list = D('Reply')->get_reply_list($filter, $page->firstRow.','.$page->listRows);
        $this->assign('list', $list);
    ...
    public function operate(){
        ...
        elseif('remove' == $act){            
            if ($this->drop($id))
            {
                //model('Admin')->admin_log($id,'remove','reply');
                clear_cache_files();
            }
            return $this->query();
        }
