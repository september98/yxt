...
CREATE DATABASE IF NOT EXISTS `yxtcmf` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `yxtcmf`;

CREATE TABLE IF NOT EXISTS `yxt_ad` (
...
CREATE TABLE IF NOT EXISTS `yxt_asset` (
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='权限规则表' AUTO_INCREMENT=183 ;
...
CREATE TABLE IF NOT EXISTS `yxt_comments` (
...
CREATE TABLE IF NOT EXISTS `yxt_common_action_log` (
...
CREATE TABLE IF NOT EXISTS `yxt_exam_kemu` (
...
CREATE TABLE IF NOT EXISTS `yxt_exam_tixing` (
  `id` int(3) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `yxt_guestbook` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `yxt_menu` (
  ...
  KEY `model` (`model`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='后台菜单表' AUTO_INCREMENT=230 ;
...
CREATE TABLE IF NOT EXISTS `yxt_oauth_user` (
...
CREATE TABLE IF NOT EXISTS `yxt_plugins` (
...
CREATE TABLE IF NOT EXISTS `yxt_posts` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `yxt_role_user` (
...
CREATE TABLE IF NOT EXISTS `yxt_section` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `cs_id` int(6) DEFAULT NULL,
